...
var CustomAttachmentLocation = class extends import_obsidian.Plugin {
  ...
  getAttachmentFolderPath(mdFolderPath, mdFileName) {
    if (mdFolderPath == ".") {
      mdFolderPath = "";
    }
  ...
  handlePaste(event, editor, view) {
    return __async(this, null, function* () {
      ...
      let mdFolderPath = view.file ? Path.dirname(view.file.path) : "";
      ...
      if (!clipBoardData.getData("text/plain")) {
        for (let i in clipBoardItems) {
          ...
          let markdownLink = view.file ? yield this.app.fileManager.generateMarkdownLink(imageFile, view.file.path) : "";
          markdownLink += "\n\n";
  ...
  handleFileOpen(file) {
    return __async(this, null, function* () {
      ...
      let mdFolderPath = Path.dirname(file.path);
      let path = this.getAttachmentFolderPath(mdFolderPath, mdFileName);
      this.updateAttachmentFolderConfig(path);
    });
  }
...
var CustomAttachmentLocationSettingTab = class extends import_obsidian.PluginSettingTab {
  ...
  display() {
    ...
    let el = new import_obsidian.Setting(containerEl).setName("Location for New Attachments").setDesc('Start with "./" to use relative path. Available variables: ${filename}, ${filepath}.(NOTE: DO NOT start with "/" or end with "/". )').addText((text) => text.setPlaceholder("./assets/${filepath}/${filename}").setValue(this.plugin.settings.attachmentFolderPath).onChange((value) => __async(this, null, function* () {
