...
2. Create a personal access token from Github:  
	...
	![](assets/README/tmp1720576693738_README_image_1.png)  
...
4.  Create a new repository:  
	![](assets/README/tmp1720576693821_README_image_2.png)
...
1. Open folder as vault:  
	![](assets/README/tmp1720576693889_README_image_3.png)
	- Select the cloned folder.
7. Setting Obsidian Git:
	- Commit Author: (type user name and email of github account)  
		![](assets/README/tmp1720576693983_README_image_4.png)
