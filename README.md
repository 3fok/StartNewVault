...
2. Create a personal access token from Github:  
	...
	![](assets/Create%20new%20Obsidian%20vault/README_image_1.png)  
...
4.  Create a new repository:  
	![](assets/Create%20new%20Obsidian%20vault/README_image_2.png)
...
1. Open folder as vault:  
	![](assets/Create%20new%20Obsidian%20vault/README_image_3.png)
	- Select the cloned folder.
7. Setting Obsidian Git:
	- Commit Author: (type user name and email of github account)  
		![](assets/Create%20new%20Obsidian%20vault/README_image_4.png)
